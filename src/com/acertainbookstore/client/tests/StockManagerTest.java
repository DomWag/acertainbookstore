...
public class StockManagerTest {
	...
	@Test
	public void testGetBookInDemand() throws BookStoreException {
		Set<StockBook> booksToAdd = new HashSet<StockBook>();
		booksToAdd.add(new ImmutableStockBook(3333, "Bla", "blub", (float) 55, NUM_COPIES, 5, 1, 10, false));
		booksToAdd.add(new ImmutableStockBook(4444, "Bla", "blub", (float) 55, NUM_COPIES, 3, 2, 10, false));
		...
		List<StockBook> missedBooks = storeManager.getBooksInDemand();

		assertTrue(missedBooks.size() == 2);
	}
